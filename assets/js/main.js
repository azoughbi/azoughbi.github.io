! function t(e, n, i) {
    ...
    1: [
        function(t, e) {
            (function(n) {
                TweenLite = n.TweenLite = t("/Users/cmalven/Dropbox (Personal)/One_Design_Company/odc_website_2014/Dev/odc-web/bower_components/gsap/src/uncompressed/TweenLite.js"), __browserify_shim_require__ = t,
                function(t, e, n, i, r) {
                    ...
                    ! function(e) {
                        ...
                        if (!n.TweenLite) {
                            var r, o, s, a, l, u = function(t) {
                                ...
                                m = {}, g = function(r, o, s, a) {
                                    ...
                                    this.check = function(c) {
                                        ...
                                        if (0 === y && s)
                                            for (p = ("com.greensock." + r).split("."), h = p.pop(), d = u(p.join("."))[h] = this.gsClass = s.apply(s, l), a && (n[h] = d, "function" == typeof i && i.amd ? i((e.GreenSockAMDPath ? e.GreenSockAMDPath + "/" : "") + r.split(".").join("/"), [], function() {
                                                return d
                            ...
                            var _ = [0, 0, 1, 1],
                                ...
                                b = x.map = {}, T = x.register = function(t, e, n, i) {
                            ...
                            var N = [],
                                R = {}, I = j._internals = {
                                    ...
                                    isSelector: D,
                                    lazyTweens: N
                                }, M = j._plugins = {}, F = I.tweenLookup = {}, q = 0,
                                z = I.reservedProps = {
                                    ease: 1,
                                    delay: 1,
                                    overwrite: 1,
                        ...
                        window._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(t, e) {
                            ...
                            var u, c, f, p, h, d, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                                ...
                                q = function() {
                                    ...
                                    return f = -1 !== F.indexOf("Safari") && -1 === F.indexOf("Chrome") && (-1 === e || Number(F.substr(e + 8, 1)) > 3), h = f && Number(F.substr(F.indexOf("Version/") + 8, 1)) < 6, p = -1 !== F.indexOf("Firefox"), /MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(F) && (d = parseFloat(RegExp.$1)), n.innerHTML = "<a style='top:1px;opacity:.55;'>a</a>", t = n.getElementsByTagName("a")[0], t ? /^0.55/.test(t.style.opacity) : !1
                                }(),
                                z = function(t) {
                                ...
                                }, Y = N.defaultView ? N.defaultView.getComputedStyle : function() {}, U = s.getStyle = function(t, e, n, i, r) {
                                    var o;
                ...
                (function() {
                    ...
                    function m(t) {
                        ...
                        var di = t.Array,
                            ...
                            Fi = function() {
                                try {
                                    var t = {}, e = ue(e = wi.defineProperty) && e,
                                        n = e(t, t, t) && e
                                } catch (i) {}
                                return n
                            }(),
            ...
            n = t("jquery"), s = t("TweenLite"), o = t("TimelineLite"), i = t("CSSPlugin"), u = t("store"), a = t("lettering"), l = t("./set_path_lengths"), e.exports = r = function() {
                function e(t) {
                    this.options = t, this._restartFallbackAnim = c(this._restartFallbackAnim, this), this._restart = c(this._restart, this), this._buildFullAnimation = c(this._buildFullAnimation, this), this._buildFallbackAnimation = c(this._buildFallbackAnimation, this), this._startIntro = c(this._startIntro, this), this._svgLoaded = c(this._svgLoaded, this), this._init = c(this._init, this), this.options = n.extend(this.options, {
                        ...
                        svgPath: "assets/images/intro-anim.svg"
                    }), this._init()
                }
    ...
    29: [
        function(t, e) {
            ...
            n = t("jquery"), i = t("../modules/intro_animator"), e.exports = r = function() {
                var t;
                return t = function() {
                    return ODC.isSmallView ? void 0 : Modernizr.ie ? n(".js-intro-anim").load("assets/images/intro-anim-fallback.svg", function() {
